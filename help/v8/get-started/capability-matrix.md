...
* Marketing calendar. [Learn more](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-create.html#campaign-calendar){target="_blank"}
* Programs and Plans. [Learn more](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-create.html#work-with-plan-and-program){target="_blank"}
* Providers, budget and cost management. [Learn more](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/providers--stocks-and-budgets.html){target="_blank"}
* Distributed marketing (Central/Local marketing). [Learn more](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html){target="_blank"}
...
* Online surveys. [Learn more](https://experienceleague.adobe.com/docs/campaign-classic/using/online-surveys/about-surveys.html){target="_blank"}
...
With this new user interface, you can also use Assets from Adobe Experience Manager 6.5 in an email content, manage email template synchronization from Adobe Experience Manager, and integrate with Adobe Experience Manager as a Cloud Service.
...
* Export/download a report as a CSV or PDF file. [Learn more](https://experienceleague.adobe.com/docs/campaign-classic/using/reporting/creating-new-reports/actions-on-reports.html){target="_blank"}
