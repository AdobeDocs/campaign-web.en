...
1. Select a template for this landing page:
    * Acquisition
    * Subscription
    * Unsubscription
    * Denylist
...
1. Add a label. You can add a description if needed.

    ![](assets/lp_create-lp-details.png)

1. Execution folder?

1. In the **[!UICONTROL Pages]** section, click each page to edit its properties.

1. Select the main/primary page.

    The primary page properties display. Learn how to configure the primary page settings [here](#configure-primary-page).

    ![](assets/lp_primary-page.png)

1. To edit a page content, click the **[!UICONTROL Web designer]** button. [Learn how to design landing page content](lp-content.md)

1. Click the + icon to add a subpage. Learn how to configure the subpage settings [here](#configure-subpages).

    ![](assets/lp_add-subpage.png)

Once you configured and designed the [main/primary page](#configure-primary-page), and the [subpages](#configure-subpages) if any, you can [test](#test-landing-page) and [publish](#publish-landing-page) your landing page.
...
>title="Define your primary page"
