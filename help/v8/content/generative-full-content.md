...
---
# Generate full content {#generative-full-content}
...
Use AI in Adobe Campaign Web to generate complete content experiences across your email, landing pages, and push notification channels. AI helps you optimize the impact of your deliveries by creating comprehensive content that resonates with your audience.

## For Email and Landing page {#email-web-channels}

Use AI to produce complete content experiences for your email deliveries and landing pages, generating both text and images. This robust functionality helps you create compelling, on-brand content that connects with your audience across all digital touchpoints.

### Access and configure {#access-configure}

Before you begin creating content with AI, you will need to set up your delivery and open the content editor. Use the steps below to prepare your workspace and access the Generate Content panel.
...
1. Personalize your layout as needed and access the **[!UICONTROL Generate Content]** menu.

    ![Generate Content panel showing brand selection and prompt field](assets/full-email-1.png){zoomable="yes"}

### Generate full content {#generate-content}

With Generate Content open, you can now configure the generation settings to create content that matches your brand and campaign goals. Customize text and image parameters, add brand assets, and provide prompts to guide the AI in generating relevant variations for your audience.
...
Generate Content also supports content generation for mobile push notifications, enabling you to create engaging titles, messages, and images for your mobile apps. This helps you maintain consistent, high-quality communication across all customer touchpoints, including mobile.

### Access and configure {#mobile-access-configure}

To use AI to generate content for push notifications, first set up your push delivery and open the content editor. The steps below will guide you through preparing your delivery and accessing the Generate Content tools.
...
1. Access the **[!UICONTROL Show Generate Content]** menu.
    ...
    ![Screenshot showing the Show Generate Content menu](assets/push-genai-1.png){zoomable="yes"}

### Generate full content {#mobile-generate-content}

Once you have accessed Generate Content for push notifications, you can configure the generation settings to create compelling mobile content. Define your text and image preferences, select brand assets, and use prompts to generate push notification variations that engage your mobile users.
...
1. Tailor your prompt with the **[!UICONTROL Text settings]** option:
    ...
    * **[!UICONTROL Communication strategy]**: Choose the most suitable communication style for your generated text.
    * **[!UICONTROL Languages]**: Choose the language of your generated content.
    * **[!UICONTROL Tone]**: The tone of your push notifications should resonate with your audience. Whether you want to sound informative, playful, or persuasive, AI can adapt the message accordingly.
...
Learn how to use AI to generate full email content, text, and images.
