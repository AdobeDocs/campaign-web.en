...
1. Choose the attribute to display in the column then confirm. Note that you can leverage the expression editor to select the attribute to use by clikcing the **[!UICONTROL Edit expression]** button. [Learn how to select attributes and add them to favorites](../get-started/attributes.md)
