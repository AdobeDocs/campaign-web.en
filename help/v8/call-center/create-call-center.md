...
When the deivery content is ready, you can preview it using test profiles and send proofs. You can then send the direct mail delivery to generate the extraction file.
