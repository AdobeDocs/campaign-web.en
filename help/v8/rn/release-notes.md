...
* You can now export data from any list tables including tracking logs. Find your list and simply click the export button. The export includes the rows currently loaded and takes into account the columns displayed on screen and any active search or filters. <!-- [Learn more](../get-started/list-filters.md) -->
