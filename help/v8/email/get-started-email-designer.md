...
* **Select an existing content** from a list of built-in or custom templates. Learn how to work with email templates in [this section](../content/create-email-templates.md).
