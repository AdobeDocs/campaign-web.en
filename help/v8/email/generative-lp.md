...
1. From the **[!UICONTROL Brand assets]** menu, click **[!UICONTROL Upload brand asset]** to add any brand asset that provides additional context to the AI Assistant, or select a previously uploaded one.
    ...
    ![Screenshot showing the brand assets menu.](assets/lp_full_gen_5.png){zoomable="yes"}
...
1. Fine-tune the content by describing what you want to generate in the **[!UICONTROL Prompt]** field. 
    ...
    ![Screenshot showing the Prompt Library interface.](assets/lp-image-gen-2.png){zoomable="yes"}
...
1. Choose **[!UICONTROL Generate Similar]** if you want to view related images to this variant.
    ...
    ![Screenshot showing the variation suggestions interface.](assets/lp-image-gen-4.png){zoomable="yes"}
