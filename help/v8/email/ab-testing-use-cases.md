---
audience: end-user
title: Content experiment use cases
description: Explore practical use cases for content experiments with A/B testing in Adobe Campaign Web
exl-id: 7c7d7e0e-8c8e-4e5e-9f9e-0e5e5e5e5e5e
---
# Content experiment use cases {#content-experiment-use-cases}
